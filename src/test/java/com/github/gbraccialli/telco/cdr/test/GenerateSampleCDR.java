...
public class GenerateSampleCDR {
    ...
    final static String[] cells = new String[]{ 
							    "cell A",
							    "cell B",
							    "cell C",
							    "cell D",
	...
	public static void generateCDRdata() throws Exception{
        ...
        try {
    		while (true){
    			...
    			for (long i =0; i < rows; i++){
    				writer.write(dropoffPair(currentTimestamp));
    				currentTimestamp += milisBetweenRows;
    			}
	...
	public static String networkChangeRowsPair(long timestmap){
		...
		String cell = cells[cellid];
		String cell2 = cells[cellid2];
		String networktype = rnd.nextInt(2) == 0 ? "1" : "2";
		String networktype2 = networktype.equals("1") ? "2" : "1";
		
		return sessionnumber + "," + simcard + "," + phonenumber + "," + openingtime + "," + duration + "," + cell + "," + networktype + "\n" +
		sessionnumber + "," + simcard + "," + phonenumber + "," + openingtime + "," + duration + "," + cell2 + "," + networktype2 + "\n";
	...
	public static String dropoffPair(long timestamp){
		...
		String openingtime2 = cdrDataFormat.format(timestamp + duration*1000 + rnd.nextInt(50)*1000);
		...
		return sessionnumber + "," + simcard + "," + phonenumber + "," + openingtime + "," + duration + "," + cell + "," + networktype + "\n" +
		sessionnumber + "," + simcard + "," + phonenumber + "," + openingtime2 + "," + duration2 + "," + cell + "," + networktype + "\n";
